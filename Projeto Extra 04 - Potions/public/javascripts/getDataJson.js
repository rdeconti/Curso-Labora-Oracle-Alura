...
function getJson(){
  ...
  xhr.open("GET", "http://localhost:3001/potions");
...
function generateListItem(itemJson){
  ...
  itemList.appendChild(formatListItem(itemJson.image, "productImage"));
  itemList.appendChild(formatListItem(itemJson.name, "productHeader"));
  itemList.appendChild(formatListItem(itemJson.price, "productParagraph"));
